...
<head>
    <meta charset="UTF-8">
    <title>E D I T P O S T - N T T</title>
...
<body>
    <div class="container">
        ...
        <hr>
        <h2>Tiêu đề</h2>
        <input type="text" id="title-name" placeholder="Tên tiêu đề" style="width: 300px;"><br><br>
        <h2>Loại tin</h2>
        <select id="mySelect">
          <optgroup label="Danh Mục">
            ...
            <option value="ĐT">Đào Tạo</option>
        ...
        <div align="center">
            <button class="pure-button ok-sua" id="<?php echo $row["id"] ?>">Lưu Chỉnh Sửa</button>
...
<script>
$("#title-name").val("<?php echo $row["title"] ?>");
$("#ndcy").val("<?php echo $row["ndcy"] ?>");
$("#mySelect").val("<?php echo $row["danhmuc"] ?>");
var HTMLstring = '<?php echo $row["pos"] ?>';
